    ...
    case Qt::Key_F:
        ...
        if(f_ireMario){
            ...
            if((fireMario->direction() == 0) && (fireMario->standingDirection() == -1)){
                ...
                connect(fireBall, &FireBall::playTheSound, this, &MyScene::playASound);
                connect(fireBall, &FireBall::playHitWarpSound, this, &MyScene::playHitWarp);
                break;
            }           
